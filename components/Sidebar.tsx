...
interface SidebarProps {
  activeView: ViewType;
  // optional to be defensive for local-dev wiring
              ...
              <li key={item.view}>
                <a
                  ...
                  onClick={(e) => {
                      e.preventDefault();
                      try {
                        console.debug('Sidebar: click', item.view);
                        if (typeof setActiveView === 'function') {
                          setActiveView(item.view);
                        } else {
                          console.warn('Sidebar: setActiveView is not a function');
                        }
                      } catch (err) {
                        console.error('Sidebar click handler error', err);
                      }
